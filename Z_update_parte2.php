...
session_start();
	...
	if (!empty($_POST)) {
		...
		if ($_update != "se") {
			...
			echo "aggiornamento riuscito! Torna <a href='Z_select.php'>qui</a> alla voce <b>".$tabella_corrente ."</b> per vedere il risultato";
		...
		$conn = "host=localhost port=5432 dbname=ospedali_regionali user=postgres password = unimi";
				...
				echo "<table>";
				echo "<th>";	
				echo "<form method='POST' action='Z_update_parte1.php'>";
